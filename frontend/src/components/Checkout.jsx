...
const Checkout = ({ cartItems }) => {
  ...
  return (
    <div className="w-full bg-[#FAF5EC] min-h-screen pt-24 md:pt-32 pb-16 relative font-sans">
            ...
            <div className="bg-white/60 backdrop-blur-md p-5 md:p-6 lg:p-10 rounded-[1.5rem] md:rounded-[2rem] text-[#2a2a2a] sticky top-28 border border-[#EADFC8]/50 shadow-sm">
              ...
              {total < 5000 ? (
                ...
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl">
                  <p className="text-[13px] text-[#2a2a2a] font-medium leading-relaxed">
                    <span className="font-bold text-green-600">Free Delivery!</span> Your order qualifies for free delivery as the total is Rs. 5000 or above.
                  </p>
                </div>
              )}
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-[100] bg-transparent pointer-events-auto flex items-start justify-center pt-8 md:pt-10">
