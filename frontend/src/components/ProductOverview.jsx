    ...
    <div className="w-full bg-[#FAF5EC] min-h-screen pt-28 pb-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          {/* Left Column - Images */}
          <div className="flex flex-col-reverse md:flex-row gap-4 md:gap-5 h-fit">
            {/* Thumbnails */}
            <div className="flex flex-row md:flex-col justify-between md:justify-center gap-2 md:gap-4 w-full md:w-24 shrink-0">
              ...
              <div className="flex items-center mt-1">
                ...
                <div className="flex gap-3 text-[#9A9286]">
                  <button
                    ...
                    className="w-8 h-8 rounded-full bg-white/80 border border-[#EADFC8] flex items-center justify-center hover:bg-[#E6B754] hover:text-white hover:border-[#E6B754] transition-colors shadow-sm"
                    aria-label="Share"
                  >
