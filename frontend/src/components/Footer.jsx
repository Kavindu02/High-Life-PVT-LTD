        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/94760454514" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#3a3a3a] flex items-center justify-center hover:bg-[#E6B754] text-[#fcf5e5] transition-all duration-300 hover:scale-110">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
