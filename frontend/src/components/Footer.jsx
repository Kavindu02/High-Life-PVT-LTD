        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              {/* Facebook */}
              <a href="#" className="w-10 h-10 rounded-full bg-[#3a3a3a] flex items-center justify-center hover:bg-[#E6B754] text-[#fcf5e5] transition-all duration-300 hover:scale-110">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              {/* WhatsApp */}
              <a href="https://wa.me/" className="w-10 h-10 rounded-full bg-[#3a3a3a] flex items-center justify-center hover:bg-[#E6B754] text-[#fcf5e5] transition-all duration-300 hover:scale-110">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'About', 'Collection', 'Blog', 'Contact'].map((link) => (
                <li key={link}>
