    ...
    <section id="story" className="w-full relative" style={{ background: 'linear-gradient(to bottom right, #B69F73 50%, #FBF5EB 50%)' }}>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row-reverse relative z-10 pt-24 pb-24 px-6 gap-12 md:gap-0">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center pr-0 md:pr-12">
          ...
          <div className="bg-[#FBF5EB] p-8 md:p-6 lg:p-16 shadow-2xl relative">
            ...
            <h2 className="text-4xl md:text-4xl lg:text-6xl font-extrabold text-[#2a2a2a] mb-6 lg:mb-8 leading-[1.1] tracking-tight">
              The Story of<br />
              Sri Lankan Spices
            </h2>

            <p className="text-sm md:text-xs lg:text-sm text-[#2a2a2a]/80 mb-4 lg:mb-6 leading-relaxed max-w-md">
            ...
            <p className="text-sm md:text-xs lg:text-sm text-[#2a2a2a]/80 leading-relaxed max-w-md">
