    ...
    <section id="about" className="w-full relative bg-brand-cream">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row relative z-10 pt-24 pb-16 px-6">
        ...
        <div className="w-full md:w-1/2 flex flex-col">
          ...
          {/* Bottom Icons Area */}
          <div className="flex flex-wrap md:flex-nowrap justify-between md:justify-end gap-4 md:gap-8 mt-auto w-full md:pl-16 text-[#2A2A2A]">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[11px] uppercase tracking-widest font-bold opacity-90 text-shine">Secured Payment</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[11px] uppercase tracking-widest font-bold opacity-90 text-shine">Fast Delivery</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[11px] uppercase tracking-widest font-bold opacity-90 text-shine">24/7 Support</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-[11px] uppercase tracking-widest font-bold opacity-90 text-shine">Premium Quality</span>
            </div>
